    ...
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            if (false)
            {
                ...
                var msg = new MailMessage {From = new MailAddress("paulo.perez@2pip2.com", "Admin do Portal")};
                ...
                var smtpClient = new SmtpClient("smtp.office365.com", Convert.ToInt32(587));
                var credentials = new NetworkCredential(ConfigurationManager.AppSettings["ContaEmail"],
